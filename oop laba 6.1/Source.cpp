...
class Level1A : public Base, public Level1B {
public:
    int level1A_data;
};


class Level2A : public Level1A, public Level2B {
public:
    int level2A_data;
};

class Level2B : public Level1B {
public:
    int level2B_data;
};
...
class VirtualLevel1A : virtual public VirtualBase, virtual public VirtualLevel1B {
public:
    int level1A_data;
};

class VirtualLevel2B : virtual public VirtualLevel1B {
public:
    int level2B_data;
};

class VirtualLevel2A : virtual public VirtualLevel1A, virtual public VirtualLevel2B {
public:
    int level2A_data;
};
